 ...
 *
 *****************************************************************************/
#ifndef _RTL8733B_HAL_H_
#define _RTL8733B_HAL_H_
 ...
 */
#define REG_LEDCFG0		REG_LED_CFG_8733B	/* rtw_mp.c */
#define MSR			(REG_CR_8733B + 2)	/* rtw_mp.c & hal_com.c */
#define MSR1			REG_CR_EXT_8733B	/* rtw_mp.c & hal_com.c */
#define REG_C2HEVT_MSG_NORMAL	0x1A0			/* hal_com.c */
#define REG_C2HEVT_CLEAR	0x1AF			/* hal_com.c */
#define REG_BCN_CTRL_1		REG_BCN_CTRL_CLINT0_8733B	/* hal_com.c */

#define REG_WOWLAN_WAKE_REASON	0x01C7 /* hal_com.c */
#define REG_GPIO_PIN_CTRL_2 		REG_GPIO_EXT_CTRL_8733B	/* hal_com.c */
#define REG_FIFOPAGE 				REG_FIFOPAGE_INFO_8733B /* hal_com.c */
#define REG_RXPKTBUF_CTRL 			REG_PKTBUF_DBG_CTRL_8733B /* hal_com.c */
#define REG_WKFMCAM_NUM 			REG_WKFMCAM_CMD_8733B /* hal_com.c */
#define REG_RSV_CTRL 				REG_REG_ACCESS_CTRL_8733B /* hal_com.c */
#define REG_CAMCMD					REG_KEYCAMCMD_8733B /* hal_com.c */
#define REG_CAMWRITE				REG_KEYCAM_WD_8733B /* hal_com.c */

#define BIT_AUTO_SYNC_BY_TBTT 		BIT_EN_TSFAUTO_SYNC_8733B /* hal_com.c */
#define BIT_DIS_ATIM_ROOT_8733B  	23 /* REG_HIQ_NO_LMT_EN_V2[23], disable ATIM ROOT */
#define BIT_SECCAM_POLLING_8733B	BIT_KEYCAM_POLLING_8733B /* rtl8733b_ops.c */
#define BIT_GET_NETYPE2				BIT_GET_P2_NETSTATE_8733B /* hal_halmac.c */
#define BIT_GET_NETYPE3				BIT_GET_P3_NETSTATE_8733B /* hal_halmac.c */
#define BIT_GET_NETYPE4				BIT_GET_P4_NETSTATE_8733B /* hal_halmac.c */
...
#define RXERR_COUNTER_MASK		BIT_MASK_RPT_COUNTER_8733B
#define RXERR_RPT_RST			BIT_RXERR_RPT_RST_8733B
#define _RXERR_RPT_SEL(type)		(BIT_RXERR_RPT_SEL_V1_3_0_8733B(type) \
					| ((type & 0x10) ? BIT_RXERR_RPT_SEL_V1_4_8733B : 0))
...
#define rHSSIRead_Jaguar		0x8B0	/* RF read addr (rtl8733b_phy.c) */
...
/* TX BeamForming */
#define REG_BB_TX_PATH_SEL_1_8733B	0x93C	/* rtl8733b_phy.c */
#define REG_BB_TX_PATH_SEL_2_8733B	0x940	/* rtl8733b_phy.c */

/* TX BeamForming */
#define REG_BB_TXBF_ANT_SET_BF1_8733B	0x19AC	/* rtl8733b_phy.c */
#define REG_BB_TXBF_ANT_SET_BF0_8733B	0x19B4	/* rtl8733b_phy.c */
...
#define rA_PIRead_Jaguar		0xD04	/* RF readback with PI (rtl8733b_phy.c) */
#define rA_SIRead_Jaguar		0xD08	/* RF readback with SI (rtl8733b_phy.c) */
#define rB_PIRead_Jaguar		0xD44	/* RF readback with PI (rtl8733b_phy.c) */
#define rB_SIRead_Jaguar		0xD48	/* RF readback with SI (rtl8733b_phy.c) */
...
#define RF_CHNLBW		0x18	/* rtl8733b_phy.c */
#define RF_ModeTableAddr	0x30	/* rtl8733b_phy.c */
#define RF_ModeTableData0	0x31	/* rtl8733b_phy.c */
#define RF_ModeTableData1	0x32	/* rtl8733b_phy.c */
#define RF_0x52			0x52
#define RF_WeLut_Jaguar		0xEF	/* rtl8733b_phy.c */

#ifdef CONFIG_FW_HANDLE_TXBCN
/*
 * CONFIG_FW_HANDLE_TXBCN
 */
#define REG_ATIMWND REG_ATIMWND_GROUP1_8733B
#define REG_ATIMWND1_V1 REG_ATIMWND_GROUP2_8733B
#define REG_ATIMWND2 REG_ATIMWND_GROUP3_8733B
#define REG_ATIMWND3 REG_ATIMWND_GROUP4_8733B
#define REG_HIQ_NO_LMT_EN REG_HIQ_NO_LMT_EN_V2_8733B
#define REG_MBSSID_CTRL REG_MBID_BCNQ_EN_8733B
...
#define BIT_PWRBIT_OW_EN	BIT_WMAC_TCR_PWRMGT_CTL_8733B

/*
* General Functions
*/
void rtl8733b_init_hal_spec(PADAPTER);				/* hal/hal_com.c */

#ifdef CONFIG_MP_INCLUDED
/* MP Functions */
#include <rtw_mp.h>		/* struct mp_priv */
void rtl8733b_prepare_mp_txdesc(PADAPTER, struct mp_priv *);	/* rtw_mp.c */
void rtl8733b_mp_config_rfpath(PADAPTER);			/* hal_mp.c */
#endif
void hw_var_set_dl_rsvd_page(PADAPTER adapter, u8 mstatus);

#ifdef CONFIG_USB_HCI
#include <rtl8733bu_hal.h>
#elif defined(CONFIG_SDIO_HCI)
#include <rtl8733bs_hal.h>
#endif

#endif /* _RTL8733B_HAL_H_ */
